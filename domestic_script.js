document.addEventListener('DOMContentLoaded', () => {
    ...
    const csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTlys14AiGHJNcXDBF-7tgiPZhIPN4Kl90Ml5ua9QMivwQz0_8ykgI-jo8fB3c9TZnUrMjF2Xfa3FO5/pub?gid=555724965&single=true&output=csv';
    ...
    function renderPodium(topPerformers) {
        ...
        // Function to update a podium slot
    ...
    function showDetailsModal(data) {
        const growthTarget = parseFloat(data['Domestic Trip Amount Target'].replace(/,/g, '')) || 0;
        ...
        const freshCustomerTarget = parseFloat(data['Domestic Trip Fresh Customer Target']) || 0;
